...
// 	$labels = array(
// 		'name'                  => _x( 'Kariera', 'Post Type General Name', 'theme' ),
// 		'singular_name'         => _x( 'Kariera', 'Post Type Singular Name', 'theme' ),
// 		'menu_name'             => __( 'Kariera', 'theme' ),
// 	);
// 	$args = array(
// 		'label'                 => __( 'Kariera', 'theme' ),
// 		'labels'                => $labels,
//         'supports'              => array( 'title', 'author', 'editor' ),
//         'rewrite'               => array('slug' => 'kariera', 'with_front' => false),
// 		'hierarchical'          => true,
// 		'public'                => true,
// 		'show_ui'               => true,
// 		'show_in_menu'          => true,
